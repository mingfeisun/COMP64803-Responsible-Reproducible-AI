...
def SGD(dT, Qdot, weight, bias, epochs, batchSize, learningRate):# Training Loop
    ...
    for i in range(epochs):
        ...
        for n in range(steps):
            ...
            MSE = (1/batchSize) * np.sum((Qdot_batch - (weight*dT_batch + bias))**2,axis=2) #Bug axis = 2 instead of axis = 0
            ...
            MSE_epoch = (1/dT.shape[2]) * np.sum((Qdot - (weight*dT + bias))**2,axis=2) #Bug set dT.shape[2] instead of dT.shape[0] and axis=2
